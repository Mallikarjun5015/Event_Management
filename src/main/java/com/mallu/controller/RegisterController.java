...
import com.mallu.serviceInterface.RegisterService;
...
public class RegisterController {
	...
	public String userLogin(RegisterEntity entity, HttpSession session, Model model) {
		...
		if (status.equals("success")) {
			...
			if (entity.getUserEmail().equals("mallikarjunjamadar777@gmail.com") && (entity.getUserPassword().equals("Password@123"))) {
